...
import { BRAND_NAME, COMPANY_NAME } from "@/constants/brand.constants";
        ...
        <div className="prose prose-slate max-w-none dark:prose-invert">
          <section className="mb-12">
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              the {BRAND_NAME} mobile application and web services
              (collectively, the "Service"), operated by {COMPANY_NAME} ("we,"
              "us," or "our").
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              Area) to use our Service. By using the Service, you represent and
              warrant that:
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--color-text-secondary)]">
              We offer three subscription tiers: Free, Reflect, and Thrive. Each
              tier provides different features and usage limits as described on
              our pricing page.
            </p>
            ...
            <ul className="mt-2 list-disc pl-6 text-[var(--color-text-secondary)]">
              <li>
                Paid subscriptions are billed in advance on a monthly or yearly
                basis
              </li>
              <li>
                Payment is processed through our third-party payment processors
                (Stripe or Razorpay)
              </li>
              <li>
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              billing period unless you cancel before the renewal date. You can
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              least 30 days' notice before any price change takes effect.
            ...
            <p className="text-[var(--color-text-secondary)]">
              We offer a 7-day money-back guarantee for annual subscriptions.
              Monthly subscriptions are non-refundable. If you're not satisfied
              within 7 days of purchasing an annual plan, contact us for a full
              refund.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              in the Service ("User Content"), including journal entries, goals,
              and templates.
            </p>
            ...
            <p className="text-[var(--color-text-secondary)]">
              By submitting User Content, you grant us a limited, non-exclusive,
              royalty-free license to:
            </p>
            <ul className="mt-2 list-disc pl-6 text-[var(--color-text-secondary)]">
              <li>Store and backup your content</li>
              <li>
                Process your content to provide AI-powered insights and features
              </li>
              <li>Display your content back to you across devices</li>
            </ul>
            <p className="mt-4 text-[var(--color-text-secondary)]">
              This license is solely for operating and improving the Service. We
              do not use your User Content for marketing or share it with third
              parties except as required to provide the Service or as required
              by law.
            </p>
            ...
            <p className="text-[var(--color-text-secondary)]">
              While we regularly backup data, you are responsible for
              maintaining your own backups. We recommend regularly exporting
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--color-text-secondary)]">
              Our Service includes AI-powered features for insights,
              suggestions, and chat. You acknowledge that:
            </p>
            <ul className="mt-2 list-disc pl-6 text-[var(--color-text-secondary)]">
              <li>AI-generated content is for informational purposes only</li>
              <li>
                AI suggestions should not be considered professional advice
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--color-text-secondary)]">
              The Service, including its design, features, text, graphics,
              logos, and software, is owned by us and protected by copyright,
            ...
            <p className="text-[var(--color-text-secondary)]">
              "{COMPANY_NAME}" and our logo are trademarks. You may not use
          ...
          <section className="mb-12">
            ...
            <p className="mt-4 text-[var(--color-text-secondary)]">
              We are not responsible for third-party services. Your use of
          ...
          <section className="mb-12">
            ...
            <p className="mt-4 text-[var(--color-text-secondary)]">
              ...
              times or free from defects, viruses, or other harmful components.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              settings. Upon termination, your data will be deleted within 30
              days as described in our Privacy Policy.
            </p>
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              time, with or without cause or notice, including if:
            </p>
            <ul className="mt-2 list-disc pl-6 text-[var(--color-text-secondary)]">
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              cease. We are not liable for any loss or damage resulting from
              termination.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--color-text-secondary)]">
              Before filing a claim, you agree to contact us to attempt to
              resolve the dispute informally. We will attempt to resolve
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              binding arbitration rather than in court, except where prohibited
              by law. You waive your right to a jury trial.
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              notify you of material changes via email or in-app notification at
          ...
          <section className="mb-12">
            ...
            <div className="mt-4 rounded-lg bg-[var(--color-surface-variant)] p-6">
              ...
              <p className="mt-2 text-[var(--color-text-secondary)]">
                <strong>Support:</strong> hello@aigoalreflect.online
              </p>
            </div>
          </section>
