            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4 pt-2">
                ...
                <button
                  ...
                  className="group flex w-full items-center justify-center gap-2 rounded-xl border border-[var(--color-outline-variant)]/30 bg-[var(--color-surface-high)] py-3 transition-colors duration-200 hover:bg-[var(--color-surface-bright)] disabled:opacity-50"
                >
