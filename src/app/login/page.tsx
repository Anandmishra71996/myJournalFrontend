          ...
          <div className="absolute inset-0 z-20 flex h-full flex-col justify-between p-16">
            ...
            <div className="max-w-md">
              ...
              <p className="text-lg font-light leading-relaxed text-[var(--color-text-secondary)]">
                A sanctuary for your thoughts, captured in the stillness of the
                night. Rediscover the art of reflection.
              </p>
            </div>
          ...
          <div className="w-full max-w-md">
            <div className="mb-10 lg:hidden">
              ...
              <p className="mt-2 text-sm text-[var(--color-text-secondary)]">
                Your thoughts, preserved in starlight.
              </p>
            </div>
            ...
            <div className="mb-8">
              <button
                ...
                className="group flex w-full items-center justify-center gap-3 rounded-xl border border-[var(--color-outline-variant)]/30 bg-[var(--color-surface)] px-4 py-3 text-sm font-semibold transition-all duration-200 hover:bg-[var(--color-surface-high)] disabled:opacity-50"
              >
              ...
              <div>
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs font-semibold text-[var(--color-primary)] hover:opacity-80"
                  >
                    Forgot Password?
                  </Link>
                </div>
